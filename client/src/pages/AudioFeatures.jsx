    ...
    <div className={styles.features}>
      <div className={styles.leftFlex}>
        ...
        <div className={styles.sampleAudios}>
          <video
            src="http://localhost:8000/static/ANACONDA-interview.mp4"
            autoplay
            className={styles.audio}
            onClick={() => {
              setSelectedVideo(
                "http://localhost:8000/static/ANACONDA-interview.mp4"
              );
              setPrediction(null);
            }}
          />
          <video
            src="http://localhost:8000/static/223be94c4a-cat_20230905_175349_freemium.mp4"
            autoplay
            className={styles.audio}
            onClick={() => {
              setSelectedVideo(
                "http://localhost:8000/static/223be94c4a-cat_20230905_175349_freemium.mp4"
              );
              setPrediction(null);
            }}
          />
          <video
            src="http://localhost:8000/static/70b7205fec-a-warm-welcome_20230904_165533_freemium.mp4"
            autoplay
            className={styles.audio}
            onClick={() => {
              setSelectedVideo(
                "http://localhost:8000/static/70b7205fec-a-warm-welcome_20230904_165533_freemium.mp4"
              );
              setPrediction(null);
            }}
          />
          <video
            src="http://localhost:8000/static/smartest-kid.mp4"
            autoplay
            className={styles.audio}
            onClick={() => {
              setSelectedVideo("http://localhost:8000/static/smartest-kid.mp4");
              setPrediction(null);
            }}
          />
        </div>
